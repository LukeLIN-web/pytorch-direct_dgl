    ...
    with th.no_grad():
        while(1):
            ...
            if flag:
                ...
                gather_feat2 =  dgl.utils.gather_pinned_tensor_rows(train_nfeat,  idxf2[0:idxf2_len].to(device=device))
                in_feat2[0:idxf2_len].copy_(gather_feat2)
                gather_label2 = dgl.utils.gather_pinned_tensor_rows(train_labels, idxl2[0:idxl2_len].to(device=device))
                in_label2[0:idxl2_len].copy_(gather_label2)
            flag = (flag == False)
